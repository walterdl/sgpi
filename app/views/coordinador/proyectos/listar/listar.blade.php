...
@section('contenido')
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row" ng-if="informe_avance!=null" class="nga-slow nga-stagger-fast nga-fade">
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <br />
                                            <label>
                                                <input ng-model="informe_avance.aprobado" type="checkbox" class="big-checkbox" ng-disabled="true">
                                                <span ng-if="informe_avance.aprobado" style="font-weight: 500;">Aprobado</span><span ng-if="!informe_avance.aprobado" style="font-weight: 500;">No aprobado</span>
                                            </label>
                                            <br />
                                            <br />
                                        </div>
                                    ...
                                    <div class="row" ng-show="final_proyecto!=null" class="nga-fast nga-stagger-fast nga-fade">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <br />
                                                <label>
                                                    <input ng-model="final_proyecto.aprobado" type="checkbox" class="big-checkbox" ng-disabled="true">
                                                    <span ng-if="final_proyecto.aprobado" style="font-weight: 500;">Aprobado</span><span ng-if="!final_proyecto.aprobado" style="font-weight: 500;">No aprobado</span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row" ng-show="prorroga!=null" class="nga-fast nga-stagger-fast nga-fade">
                                        ...
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <br />
                                                <label>
                                                    <input ng-model="prorroga.aprobado" type="checkbox" class="big-checkbox" ng-disabled="true">
                                                    <span ng-if="final_proyecto.aprobado" style="font-weight: 500;">Aprobado</span><span ng-if="!final_proyecto.aprobado" style="font-weight: 500;">No aprobado</span>
                                                </label>
                                            </div>
                                        </div>
    ...
    @include('coordinador.proyectos.listar.modales')
