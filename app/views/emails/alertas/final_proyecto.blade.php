...
<html lang="es">
	...
	<body>
		<p style="font-family:'Source Sans Pro', 'Helvetica Neue', Helvetica, Arial, sans-serif">
			...
			le informa que se aproxima la fecha de final de proyecto ({{ $proyecto->fecha_fin }}) del proyecto de investigación titulado <em>{{ $proyecto->nombre }}</em>.
			<br />
			<br />
			Este mensaje automático tiene como propósito recordarle al investigador principal, coordinación y jefatura de dicho proyecto la carga de los archivos de final de proyecto.
			Puede revisar la carga a travéz del sistema en: Gestion de proyectos &gt; final de proyecto, ingresando al sistema a travéz de su usuario: {{ $destinatario->username }}
		</p>
		<p style="font-family:'Source Sans Pro', 'Helvetica Neue', Helvetica, Arial, sans-serif">
			Enlace a SGPI:
		</p>
