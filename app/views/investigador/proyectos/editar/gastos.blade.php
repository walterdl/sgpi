                        ...
                        <div id="contenido_gastos" class="tab-pane fade active in">
                            ...
                            <div class="row is-flex">
                                ...
                                <div class="col-xs-12 col-md-6">
                                    ...
                                    multiple ng-model="entidades_fuente_presupuesto_seleccionadas"
                                    ...
                                    style="width: 100%;" theme="bootstrap"  title="Seleccionar otras entidades fuente de presupuesto...">
                                        ...
                                        <ui-select-choices repeat="entidad_presupuesto in entidades_fuente_presupuesto">
                                            ...
                                            <table class="table table-hover table-bordered" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Valor hora</th>
                                                        <th>UCC</th>
                                                        <th ng-repeat="entidad_fuente_presupuesto in entidades_fuente_presupuesto_seleccionadas">{$ entidad_fuente_presupuesto.nombre $}</th>
                                                ...
                                                <tbody>
                                                    <tr ng-repeat="gasto_personal in gastos_personal">
                                                        ...
                                                        <td>
                                                            ...
                                                            uib-tooltip="La cantidad debe ser mayor a cero" tooltip-class="tooltip-invalid_control" tooltip-trigger="'mouseenter'" tooltip-enable="gasto_personal.dedicacion_semanal_invalido"/>
                                                        </td>
                                                        <td>
                                                            ...
                                                            class="form-control" ng-class="{'invalid_control': gasto_personal.total_semanas_invalido}"
                                                            uib-tooltip="La cantidad debe ser mayor a cero" tooltip-class="tooltip-invalid_control" tooltip-trigger="'mouseenter'" tooltip-enable="gasto_personal.total_semanas_invalido"/>
                                                        </td>
                                                        <td>
                                                            ...
                                                            class="form-control" ng-class="{'invalid_control': gasto_personal.valor_hora_invalido}"
                                                            uib-tooltip="La cantidad debe ser mayor a cero" tooltip-class="tooltip-invalid_control" tooltip-trigger="'mouseenter'" tooltip-enable="gasto_personal.valor_hora_invalido"/>
                                                        </td>
                                                        <td ng-repeat="gasto in gasto_personal.gastos">
                                                            ...
                                                            ng-model="gasto.valor" ng-change="suma_totales_gasto_personal(gasto_personal, gasto.id_entidad_fuente_presupuesto)"
                                                            class="form-control" ng-class="{'invalid_control': gasto_personal.gasto_invalido[gasto.id_entidad_fuente_presupuesto]}"
                                                            uib-tooltip="La cantidad debe ser mayor a cero" tooltip-class="tooltip-invalid_control" tooltip-trigger="'mouseenter'" tooltip-enable="gasto_personal.gasto_invalido[gasto.id_entidad_fuente_presupuesto]"/>
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                ...
                                                                ng-readonly="true"
                                                                class="form-control white-readonly" ng-class="{'invalid_control': gasto_personal.fecha_ejecucion_invalido}"
                                                                uib-tooltip="Ingresar fecha" tooltip-class="tooltip-invalid_control" tooltip-trigger="'mouseenter'" tooltip-enable="gasto_personal.fecha_ejecucion_invalido"/>
                                                        ...
                                                        <td class="width-180">
                                                            {$ gasto_personal.total_gasto_personal|currency:$:2 $}
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr ng-if="gastos_personal.length>0">
                                                        ...
                                                        <td ng-repeat="entidad_fuente_presupuesto in entidades_fuente_presupuesto_seleccionadas">
                                                            {$ totales_gastos_personal.entidades_fuente_presupuesto[entidad_fuente_presupuesto.id]|currency:$ $}
                                                        </td>
                                                        <td colspan="2" class="text-right">{$ totales_gastos_personal.total|currency:$ $}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                            ...
                                            <table class="table table-hover table-bordered">
                                                <thead id="table_head_gastos_equipos">
                                                    <tr>
                                                        ...
                                                        <!--<th>UCC</th>-->
                                                        <!--<th>CONADI</th>-->
                                                        <th ng-repeat="item in data.fuente_presupuesto_equipos">{$ item.entidad_fuente_presupuesto.nombre $}</th>
                                                        <th>Fecha de ejecución</th>
                                                        <th>Total</th>
                                                        <th>Remover</th>
                                                    </tr>
                                                ...
                                                <tbody id="table_body_gastos_equipos">
                                                    ...
                                                    <tr ng-repeat="gasto_equipo in data.gastos_equipos">
                                                        ...
                                                        <td>
                                                            ...
                                                            ng-model="gasto_equipo.concepto" ng-change="validar_nombre_equipo(gasto_equipo)"
                                                        ...
                                                        <!--</td> -->
                                                        <td ng-repeat="entidad_presupuesto in gasto_equipo.gasto">
                                                            <input type="number" name="gasto_equipo_presupuesto_externo_{$ entidad_presupuesto.id $}_{$ $parent.$index $}"
                                                            ng-model="entidad_presupuesto.valor" ng-change="suma_totales_equipos(gasto_equipo, 'otro', entidad_presupuesto.id)"
                                                    ...
                                                    <tr ng-if="data.gastos_equipos.length>0">
                                                        ...
                                                        <td ng-repeat="entidad_presupuesto in data.fuente_presupuesto_equipos">
                                                            {$ 0|currency:$ $}
                                                            <!--{$ data.totales_equipos.otras_entidades_presupuesto[entidad_presupuesto.id]|currency:$ $}-->
                                                        </td>
                                                        <td>&nbsp;</td>
                                                        <td>
                                                            <!--{$ data.totales_equipos.total|currency:$ $}-->
                                                            {$ 0|currency:$ $}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <table class="table table-hover table-bordered">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <!--<th>UCC</th>-->
                                                        <!--<th>CONADI</th>-->
                                                        <th ng-repeat="item in data.fuente_presupuesto_software">{$ item.entidad_fuente_presupuesto.nombre $}</th>
                                                        <th>Fecha de ejecución</th>
                                                        <th>Total</th>
                                                        <th>Remover</th>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr ng-repeat="gasto_software in data.gastos_software">
                                                        ...
                                                        <td>
                                                            ...
                                                            ng-model="gasto_software.concepto" ng-change="validar_nombre_software(gasto_software)"
                                                        ...
                                                        <!--</td> -->
                                                        <td ng-repeat="entidad in gasto_software.gasto">
                                                            <input type="number" name="gasto_software_presupuesto_externo_{$ entidad_presupuesto.id $}_{$ $parent.$index $}"
                                                            ng-model="entidad.valor" ng-change="suma_totales_software(gasto_software, 'otro', entidad_presupuesto.id)"
