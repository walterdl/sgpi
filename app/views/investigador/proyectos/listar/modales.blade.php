...
{{--Modal desembolso personal--}}
<script type="text/ng-template" id="modal_desembolso_personal.html">
    <div class="modal-header">
        <h3 class="modal-title">Desembolso de gasto de personal</h3>
    </div>
    <div class="modal-body">
        <h4>Participante: <strong>{$ gasto_personal.nombre_completo $}</strong> ({$ gasto_personal.acronimo_id $}. {$ gasto_personal.identificacion $})</h4>
        <br />
        <div class="alert alert-warning" role="alert" ng-show="show_descargar_desembolso">
            ...
            <br />
            <a class="btn btn-primary" href="/file/desembolso_gasto_personal/{$ nombre_archivo $}">Descargar desembolso <i class="fa fa-cloud-download" aria-hidden="true"></i></a>
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6">
                <label>&nbsp;</label>
                <a class="btn btn-default btn-block" href="/file/formato/desembolso">Descargar formato de desembolso <i class="fa fa-cloud-download" aria-hidden="true"></i></a>
            </div>
            <div class="col-xs-12">
                <br />
                <label>Comentario de desembolso</label>
                <textarea rows="3" class="form-control" ng-model="comentario_desembolso"></textarea>
            </div>
            <div class="col-xs-12">
                <br />
