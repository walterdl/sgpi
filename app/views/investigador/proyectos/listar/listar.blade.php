                            ...
                            <table datatable="ng" dt-options="dtOptions" class="table table-hover table-stripped table-bordered">
                                ...
                                <tbody>
                                    <tr ng-repeat="proyecto in data.proyectos">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                <button class="fa fa-check btn btn-default dropdown-toggle" type="button" id="opciones_gestion_proyecto" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <span class="caret"></span>
                                                </button>
                                                <ul class="dropdown-menu" aria-labelledby="opciones_gestion_proyecto">
                                                    <li><a href="#" ng-click="productos(proyecto.id)"><i class="fa fa-shopping-bag" aria-hidden="true"></i>Carga de productos</a></li>
                                                    <li><a href="#" ng-click="gastos(proyecto.id)"><i class="fa fa-money" aria-hidden="true"></i>Ejecución presupuestal</a></li>
                                                    <li><a href="#" ng-click="informe_avance(proyecto.id)"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>Informe de avance</a></li>
                                                    <li><a href="#" ng-click="final_proyecto(proyecto.id)"><i class="fa fa-stop" aria-hidden="true"></i>Final de proyecto</a></li>
                                                    <li><a href="#" ng-click="prorroga(proyecto.id)"><i class="fa fa-clock-o" aria-hidden="true"></i>Prórroga de proyecto</a></li>
                                                </ul>
                                            </div>
                                        </td>
