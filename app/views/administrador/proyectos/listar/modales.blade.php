...
<script type="text/ng-template" id="modal_revision_desembolso.html">
    ...
    <div class="modal-body">
        ...
        <div class="row" ng-if="desembolso.hay_desembolso==1" class="nga-slow nga-stagger-fast nga-fade">
            ...
            <div class="col-xs-12">
                <label>Seleccione para aprobar el desembolso</label>
                <br />
                <label>
                    <input ng-model="desembolso.aprobado" type="checkbox" class="big-checkbox"> Aprobado / no aprobado
                </label>
                <br />
                <br />
            </div>
            <div class="col-xs-12">
                ...
                <textarea rows="3" ng-model="desembolso.comentario_revision" class="form-control"
                uib-tooltip="Ingresar un comentario de revisión" tooltip-enable="true"></textarea>
                <br />
            </div>                                    
            <div class="col-xs-12">
                <label>Orden de servicio</label>
                <input type="text" ng-model="desembolso.codigo_aprobacion" class="form-control" />
            </div>                        
            <div class="col-xs-12">
                <br />
    ...
    <div class="modal-footer">
        <button type="button" class="btn btn-default" ng-click="cancelar()" ng-disabled="guardando_revision">Cancelar</button>
    </div>         
</script>
