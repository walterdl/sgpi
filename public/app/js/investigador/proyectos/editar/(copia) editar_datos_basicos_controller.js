...
sgpi_app.controller('crear_proyecto_controller', function($scope, $http, $log, $window, $filter, id_usuario){
	...
	*/             
    $scope.validar_codigo_fmi = function() {
        console.log('validar_codigo_fmi()');
	...
	*/             
    $scope.validar_nombre_proyecto = function() {
        if($scope.data.proyecto.nombre && $scope.data.proyecto.nombre.length >= 5 && $scope.data.proyecto.nombre.length <= 200){
            // valido
            $scope.data.validacion_nombre_proyecto = null;
            return false;
        }
	...
	*/              
    $scope.validar_objetivo_general = function() {
        if($scope.data.proyecto.objetivo_general != null && $scope.data.proyecto.objetivo_general.length >= 5 && $scope.data.proyecto.objetivo_general.length <= 200){
            $scope.data.validacion_objetivo_general = null;
            return false;
        }
        else{
