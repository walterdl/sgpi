sgpi_app.controller('gastos_software_controller', function ($scope, $uibModal) {
	...
	*/    
    $scope.desembolso = function(gasto_software){
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: 'modal_desembolso.html',
            controller: 'modal_desembolso_software_controller',
            size: 'lg',
            scope: $scope,
            keyboard: false,
            backdrop: 'static',
...
/*
|--------------------------------------------------------------------------
| modal_desembolso_software_controller
|--------------------------------------------------------------------------
| Modal para la carga de desembolso de gasto de equipo y vista de revisión
*/              
sgpi_app.controller('modal_desembolso_software_controller', function ($scope, $http, $uibModalInstance, Upload, gasto_software){
    
    $scope.gasto_software = gasto_software;
    $scope.titulo_modal = 'Desembolso de gasto de software';
    $scope.gasto_html = '<h4>Equipo: <strong>{$ gasto_software.concepto $}</strong></h4>';
