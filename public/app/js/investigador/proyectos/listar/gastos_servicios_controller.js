sgpi_app.controller('gastos_servicios_controller', function ($scope, $uibModal) {
	...
	*/    
    $scope.desembolso = function(gasto_servicio){
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: 'modal_desembolso.html',
            controller: 'modal_desembolso_servicio_controller',
            size: 'lg',
            scope: $scope,
            keyboard: false,
            backdrop: 'static',
...
/*
|--------------------------------------------------------------------------
| modal_desembolso_servicio_controller
|--------------------------------------------------------------------------
| Modal para la carga de desembolso de gasto de servicio técnico y vista de revisión
*/              
sgpi_app.controller('modal_desembolso_servicio_controller', function ($scope, $http, $uibModalInstance, Upload, gasto_servicio){
