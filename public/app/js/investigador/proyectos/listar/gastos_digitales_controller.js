...
sgpi_app.controller('gastos_digitales_controller', function ($scope, $uibModal){
	...
	*/    
    $scope.desembolso = function(gasto_digital){
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: 'modal_desembolso.html',
            controller: 'modal_desembolso_digital_controller',
            size: 'lg',
            scope: $scope,
            keyboard: false,
            backdrop: 'static',
...
/*
|--------------------------------------------------------------------------
| modal_desembolso_digital_controller
|--------------------------------------------------------------------------
| Modal para la carga de desembolso de gasto de recurso educativo digital y vista de revisión
*/              
sgpi_app.controller('modal_desembolso_digital_controller', function ($scope, $http, $uibModalInstance, Upload, gasto_digital){
