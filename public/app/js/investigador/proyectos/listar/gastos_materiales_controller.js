sgpi_app.controller('gastos_materiales_controller', function ($scope, $uibModal) {
	...
	*/    
    $scope.desembolso = function(gasto_material){
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: 'modal_desembolso.html',
            controller: 'modal_desembolso_material_controller',
            size: 'lg',
            scope: $scope,
            keyboard: false,
            backdrop: 'static',
...
/*
|--------------------------------------------------------------------------
| modal_desembolso_material_controller
|--------------------------------------------------------------------------
| Modal para la carga de desembolso de gasto de material y vista de revisión
*/              
sgpi_app.controller('modal_desembolso_material_controller', function ($scope, $http, $uibModalInstance, Upload, gasto_material){
