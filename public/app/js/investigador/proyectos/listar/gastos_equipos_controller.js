sgpi_app.controller('gastos_equipos_controller', function ($scope, $uibModal) {
	...
	*/    
    $scope.desembolso = function(gasto_equipo){
        var modalInstance = $uibModal.open({
            animation: true,
            templateUrl: 'modal_desembolso.html',
            controller: 'modal_desembolso_equipo_controller',
            size: 'lg',
            scope: $scope,
            keyboard: false,
            backdrop: 'static',
...
/*
|--------------------------------------------------------------------------
| modal_desembolso_equipo_controller
|--------------------------------------------------------------------------
| Modal para la carga de desembolso de gasto de equipo y vista de revisión
*/              
sgpi_app.controller('modal_desembolso_equipo_controller', function ($scope, $http, $uibModalInstance, Upload, gasto_equipo){
    
    $scope.gasto_equipo = gasto_equipo;
    $scope.titulo_modal = 'Desembolso de gasto de equipo';
